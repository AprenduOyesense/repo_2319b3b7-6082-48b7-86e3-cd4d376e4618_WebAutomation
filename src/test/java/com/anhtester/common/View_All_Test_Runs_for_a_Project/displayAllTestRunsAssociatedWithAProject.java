...
public class displayAllTestRunsAssociatedWithAProject {

    private WebDriver driver;
    private String className = "displayAllTestRunsAssociatedWithAProject";
    private String subid = "TE-168";

    // Constructor to initialize WebDriver and set className and subid
    public displayAllTestRunsAssociatedWithAProject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        displayAllTestRunsAssociatedWithAProject test = new displayAllTestRunsAssociatedWithAProject(driver);
        test.runTest();
    }
}
