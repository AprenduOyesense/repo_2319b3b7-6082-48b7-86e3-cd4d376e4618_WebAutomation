...
public class removeATestCase {

    private WebDriver driver;
    private String className = "removeATestCase";
    private String subid = "TE-126";

    // Constructor to initialize WebDriver and set className and subid
    public removeATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeATestCase test = new removeATestCase(driver);
        test.runTest();
    }
}
