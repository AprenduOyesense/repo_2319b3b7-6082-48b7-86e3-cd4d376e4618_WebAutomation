...
public class removeAutomationConfiguration {

    private WebDriver driver;
    private String className = "removeAutomationConfiguration";
    private String subid = "TE-111";

    // Constructor to initialize WebDriver and set className and subid
    public removeAutomationConfiguration(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeAutomationConfiguration test = new removeAutomationConfiguration(driver);
        test.runTest();
    }
}
