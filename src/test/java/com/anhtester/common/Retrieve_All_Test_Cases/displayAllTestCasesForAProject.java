...
public class displayAllTestCasesForAProject {

    private WebDriver driver;
    private String className = "displayAllTestCasesForAProject";
    private String subid = "TE-172";

    // Constructor to initialize WebDriver and set className and subid
    public displayAllTestCasesForAProject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        displayAllTestCasesForAProject test = new displayAllTestCasesForAProject(driver);
        test.runTest();
    }
}
