...
public class removeExpectedOutcomes {

    private WebDriver driver;
    private String className = "removeExpectedOutcomes";
    private String subid = "TE230";

    // Constructor to initialize WebDriver and set className and subid
    public removeExpectedOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeExpectedOutcomes test = new removeExpectedOutcomes(driver);
        test.runTest();
    }
}
