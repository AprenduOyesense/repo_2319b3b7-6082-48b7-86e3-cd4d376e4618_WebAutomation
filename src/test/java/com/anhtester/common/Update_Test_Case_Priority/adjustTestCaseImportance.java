...
public class adjustTestCaseImportance {

    private WebDriver driver;
    private String className = "adjustTestCaseImportance";
    private String subid = "TE-124";

    // Constructor to initialize WebDriver and set className and subid
    public adjustTestCaseImportance(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        adjustTestCaseImportance test = new adjustTestCaseImportance(driver);
        test.runTest();
    }
}
