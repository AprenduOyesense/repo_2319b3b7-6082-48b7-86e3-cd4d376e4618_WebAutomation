...
public class leaveACommentOnATestCase {

    private WebDriver driver;
    private String className = "leaveACommentOnATestCase";
    private String subid = "TE-153";

    // Constructor to initialize WebDriver and set className and subid
    public leaveACommentOnATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        leaveACommentOnATestCase test = new leaveACommentOnATestCase(driver);
        test.runTest();
    }
}
