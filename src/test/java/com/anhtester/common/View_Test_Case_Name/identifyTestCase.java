...
public class identifyTestCase {

    private WebDriver driver;
    private String className = "identifyTestCase";
    private String subid = "TE-130";

    // Constructor to initialize WebDriver and set className and subid
    public identifyTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        identifyTestCase test = new identifyTestCase(driver);
        test.runTest();
    }
}
