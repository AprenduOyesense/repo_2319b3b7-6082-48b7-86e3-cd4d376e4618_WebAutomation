...
public class startANewTestRunForAProject {

    private WebDriver driver;
    private String className = "startANewTestRunForAProject";
    private String subid = "TE-164";

    // Constructor to initialize WebDriver and set className and subid
    public startANewTestRunForAProject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        startANewTestRunForAProject test = new startANewTestRunForAProject(driver);
        test.runTest();
    }
}
