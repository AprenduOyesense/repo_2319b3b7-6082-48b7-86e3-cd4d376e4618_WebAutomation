...
public class viewResultOfASpecificTestCase {

    private WebDriver driver;
    private String className = "viewResultOfASpecificTestCase";
    private String subid = "TE-163";

    // Constructor to initialize WebDriver and set className and subid
    public viewResultOfASpecificTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewResultOfASpecificTestCase test = new viewResultOfASpecificTestCase(driver);
        test.runTest();
    }
}
