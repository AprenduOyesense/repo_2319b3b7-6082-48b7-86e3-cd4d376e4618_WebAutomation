...
public class viewTestCasesIncludedInASpecificTestRun {

    private WebDriver driver;
    private String className = "viewTestCasesIncludedInASpecificTestRun";
    private String subid = "TE-166";

    // Constructor to initialize WebDriver and set className and subid
    public viewTestCasesIncludedInASpecificTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewTestCasesIncludedInASpecificTestRun test = new viewTestCasesIncludedInASpecificTestRun(driver);
        test.runTest();
    }
}
