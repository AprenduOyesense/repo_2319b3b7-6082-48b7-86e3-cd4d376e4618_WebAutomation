...
public class trackHistoryOfATestCase {

    private WebDriver driver;
    private String className = "trackHistoryOfATestCase";
    private String subid = "TE-158";

    // Constructor to initialize WebDriver and set className and subid
    public trackHistoryOfATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        trackHistoryOfATestCase test = new trackHistoryOfATestCase(driver);
        test.runTest();
    }
}
