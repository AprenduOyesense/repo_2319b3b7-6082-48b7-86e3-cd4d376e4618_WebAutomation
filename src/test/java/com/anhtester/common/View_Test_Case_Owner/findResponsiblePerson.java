...
public class findResponsiblePerson {

    private WebDriver driver;
    private String className = "findResponsiblePerson";
    private String subid = "TE-138";

    // Constructor to initialize WebDriver and set className and subid
    public findResponsiblePerson(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        findResponsiblePerson test = new findResponsiblePerson(driver);
        test.runTest();
    }
}
