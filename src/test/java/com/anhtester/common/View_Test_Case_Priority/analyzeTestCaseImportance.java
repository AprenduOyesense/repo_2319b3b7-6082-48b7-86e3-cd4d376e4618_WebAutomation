...
public class analyzeTestCaseImportance {

    private WebDriver driver;
    private String className = "analyzeTestCaseImportance";
    private String subid = "TE-125";

    // Constructor to initialize WebDriver and set className and subid
    public analyzeTestCaseImportance(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        analyzeTestCaseImportance test = new analyzeTestCaseImportance(driver);
        test.runTest();
    }
}
