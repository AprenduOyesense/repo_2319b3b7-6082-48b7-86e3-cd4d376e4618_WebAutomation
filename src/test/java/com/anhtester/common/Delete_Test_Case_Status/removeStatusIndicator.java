...
public class removeStatusIndicator {

    private WebDriver driver;
    private String className = "removeStatusIndicator";
    private String subid = "TE-120";

    // Constructor to initialize WebDriver and set className and subid
    public removeStatusIndicator(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeStatusIndicator test = new removeStatusIndicator(driver);
        test.runTest();
    }
}
