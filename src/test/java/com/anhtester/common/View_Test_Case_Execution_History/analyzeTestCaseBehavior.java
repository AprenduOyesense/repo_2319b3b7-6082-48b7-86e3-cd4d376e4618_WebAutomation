...
public class analyzeTestCaseBehavior {

    private WebDriver driver;
    private String className = "analyzeTestCaseBehavior";
    private String subid = "TE-107";

    // Constructor to initialize WebDriver and set className and subid
    public analyzeTestCaseBehavior(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        analyzeTestCaseBehavior test = new analyzeTestCaseBehavior(driver);
        test.runTest();
    }
}
