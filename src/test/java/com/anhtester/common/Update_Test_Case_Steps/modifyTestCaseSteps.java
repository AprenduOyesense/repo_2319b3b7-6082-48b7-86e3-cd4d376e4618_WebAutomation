...
public class modifyTestCaseSteps {

    private WebDriver driver;
    private String className = "modifyTestCaseSteps";
    private String subid = "TE-143";

    // Constructor to initialize WebDriver and set className and subid
    public modifyTestCaseSteps(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        modifyTestCaseSteps test = new modifyTestCaseSteps(driver);
        test.runTest();
    }
}
