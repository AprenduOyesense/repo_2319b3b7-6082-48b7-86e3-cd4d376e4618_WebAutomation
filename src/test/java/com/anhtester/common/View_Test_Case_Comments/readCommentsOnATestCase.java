...
public class readCommentsOnATestCase {

    private WebDriver driver;
    private String className = "readCommentsOnATestCase";
    private String subid = "TE-154";

    // Constructor to initialize WebDriver and set className and subid
    public readCommentsOnATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        readCommentsOnATestCase test = new readCommentsOnATestCase(driver);
        test.runTest();
    }
}
