...
public class checkCurrentStatus {
    ...
    private String className = "checkCurrentStatus";
    private String subid = "TE-122";

    // Constructor to initialize WebDriver and set className and subid
    public checkCurrentStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        checkCurrentStatus test = new checkCurrentStatus(driver);
        test.runTest();
    }
}
