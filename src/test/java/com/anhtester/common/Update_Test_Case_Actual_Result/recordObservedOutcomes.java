...
public class recordObservedOutcomes {

    private WebDriver driver;
    private String className = "recordObservedOutcomes";
    private String subid = "TE-115";

    // Constructor to initialize WebDriver and set className and subid
    public recordObservedOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        recordObservedOutcomes test = new recordObservedOutcomes(driver);
        test.runTest();
    }
}
