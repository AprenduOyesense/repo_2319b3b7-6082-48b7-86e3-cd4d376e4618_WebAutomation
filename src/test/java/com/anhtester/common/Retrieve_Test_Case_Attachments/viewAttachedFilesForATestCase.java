...
public class viewAttachedFilesForATestCase {

    private WebDriver driver;
    private String className = "viewAttachedFilesForATestCase";
    private String subid = "TE-156";

    // Constructor to initialize WebDriver and set className and subid
    public viewAttachedFilesForATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewAttachedFilesForATestCase test = new viewAttachedFilesForATestCase(driver);
        test.runTest();
    }
}
