...
public class removeObservedOutcomes {

    private WebDriver driver;
    private String className = "removeObservedOutcomes";
    private String subid = "TE-114";

    // Constructor to initialize WebDriver and set className and subid
    public removeObservedOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeObservedOutcomes test = new removeObservedOutcomes(driver);
        test.runTest();
    }
}
