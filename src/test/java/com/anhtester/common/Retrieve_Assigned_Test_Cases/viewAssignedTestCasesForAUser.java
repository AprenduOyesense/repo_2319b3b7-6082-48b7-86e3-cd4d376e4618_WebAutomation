...
public class viewAssignedTestCasesForAUser {

    private WebDriver driver;
    private String className = "viewAssignedTestCasesForAUser";
    private String subid = "TE-160";

    // Constructor to initialize WebDriver and set className and subid
    public viewAssignedTestCasesForAUser(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewAssignedTestCasesForAUser test = new viewAssignedTestCasesForAUser(driver);
        test.runTest();
    }
}
