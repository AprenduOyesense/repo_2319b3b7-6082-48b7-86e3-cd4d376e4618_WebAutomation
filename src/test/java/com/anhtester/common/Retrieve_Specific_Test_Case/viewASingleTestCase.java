...
public class viewASingleTestCase {

    private WebDriver driver;
    private String className = "viewASingleTestCase";
    private String subid = "TE-171";

    // Constructor to initialize WebDriver and set className and subid
    public viewASingleTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewASingleTestCase test = new viewASingleTestCase(driver);
        test.runTest();
    }
}
