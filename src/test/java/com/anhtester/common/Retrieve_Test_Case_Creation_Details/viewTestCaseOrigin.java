...
public class viewTestCaseOrigin {

    private WebDriver driver;
    private String className = "viewTestCaseOrigin";
    private String subid = "TE-136";

    // Constructor to initialize WebDriver and set className and subid
    public viewTestCaseOrigin(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewTestCaseOrigin test = new viewTestCaseOrigin(driver);
        test.runTest();
    }
}
