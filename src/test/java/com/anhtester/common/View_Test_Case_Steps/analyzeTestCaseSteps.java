...
public class analyzeTestCaseSteps {

    private WebDriver driver;
    private String className = "analyzeTestCaseSteps";
    private String subid = "TE-144";

    // Constructor to initialize WebDriver and set className and subid
    public analyzeTestCaseSteps(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        analyzeTestCaseSteps test = new analyzeTestCaseSteps(driver);
        test.runTest();
    }
}
