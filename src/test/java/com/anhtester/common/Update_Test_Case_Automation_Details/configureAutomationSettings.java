...
public class configureAutomationSettings {

    private WebDriver driver;
    private String className = "configureAutomationSettings";
    private String subid = "TE-112";

    // Constructor to initialize WebDriver and set className and subid
    public configureAutomationSettings(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        configureAutomationSettings test = new configureAutomationSettings(driver);
        test.runTest();
    }
}
