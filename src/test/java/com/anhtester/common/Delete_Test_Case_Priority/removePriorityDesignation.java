...
public class removePriorityDesignation {

    private WebDriver driver;
    private String className = "removePriorityDesignation";
    private String subid = "TE-123";

    // Constructor to initialize WebDriver and set className and subid
    public removePriorityDesignation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removePriorityDesignation test = new removePriorityDesignation(driver);
        test.runTest();
    }
}
