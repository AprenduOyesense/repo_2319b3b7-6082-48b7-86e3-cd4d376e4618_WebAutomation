...
public class distributeTestCasesToTesters {

    private WebDriver driver;
    private String className = "distributeTestCasesToTesters";
    private String subid = "TE-161";

    // Constructor to initialize WebDriver and set className and subid
    public distributeTestCasesToTesters(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        distributeTestCasesToTesters test = new distributeTestCasesToTesters(driver);
        test.runTest();
    }
}
