...
public class readExpectedOutcomes {

    private WebDriver driver;
    private String className = "readExpectedOutcomes";
    private String subid = "TE-119";

    // Constructor to initialize WebDriver and set className and subid
    public readExpectedOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        readExpectedOutcomes test = new readExpectedOutcomes(driver);
        test.runTest();
    }
}
