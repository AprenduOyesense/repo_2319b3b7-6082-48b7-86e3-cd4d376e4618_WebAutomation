...
public class examineAutomationSettings {

    private WebDriver driver;
    private String className = "examineAutomationSettings";
    private String subid = "TE-113";

    // Constructor to initialize WebDriver and set className and subid
    public examineAutomationSettings(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        examineAutomationSettings test = new examineAutomationSettings(driver);
        test.runTest();
    }
}
