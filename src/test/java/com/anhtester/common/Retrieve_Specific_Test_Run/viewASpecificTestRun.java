...
public class viewASpecificTestRun {

    private WebDriver driver;
    private String className = "viewASpecificTestRun";
    private String subid = "TE-167";

    // Constructor to initialize WebDriver and set className and subid
    public viewASpecificTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewASpecificTestRun test = new viewASpecificTestRun(driver);
        test.runTest();
    }
}
