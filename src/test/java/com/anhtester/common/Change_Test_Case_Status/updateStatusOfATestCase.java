...
public class updateStatusOfATestCase {

    private WebDriver driver;
    private String className = "updateStatusOfATestCase";
    private String subid = "TE-165";

    // Constructor to initialize WebDriver and set className and subid
    public updateStatusOfATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateStatusOfATestCase test = new updateStatusOfATestCase(driver);
        test.runTest();
    }
}
