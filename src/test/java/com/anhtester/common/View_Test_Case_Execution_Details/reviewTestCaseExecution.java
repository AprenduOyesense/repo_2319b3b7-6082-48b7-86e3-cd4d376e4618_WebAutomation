...
public class reviewTestCaseExecution {

    private WebDriver driver;
    private String className = "reviewTestCaseExecution";
    private String subid = "TE-134";

    // Constructor to initialize WebDriver and set className and subid
    public reviewTestCaseExecution(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        reviewTestCaseExecution test = new reviewTestCaseExecution(driver);
        test.runTest();
    }
}
