...
public class inspectTestEnvironment {

    private WebDriver driver;
    private String className = "inspectTestEnvironment";
    private String subid = "TE-135";

    // Constructor to initialize WebDriver and set className and subid
    public inspectTestEnvironment(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        inspectTestEnvironment test = new inspectTestEnvironment(driver);
        test.runTest();
    }
}