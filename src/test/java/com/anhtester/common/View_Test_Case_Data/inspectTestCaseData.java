...
public class inspectTestCaseData {

    private WebDriver driver;
    private String className = "inspectTestCaseData";
    private String subid = "TE-148";

    // Constructor to initialize WebDriver and set className and subid
    public inspectTestCaseData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        inspectTestCaseData test = new inspectTestCaseData(driver);
        test.runTest();
    }
}
