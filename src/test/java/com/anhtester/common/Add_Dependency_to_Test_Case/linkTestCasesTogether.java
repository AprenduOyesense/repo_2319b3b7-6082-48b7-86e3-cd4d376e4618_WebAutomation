...
public class linkTestCasesTogether {

    private WebDriver driver;
    private String className = "linkTestCasesTogether";
    private String subid = "TE-150";

    // Constructor to initialize WebDriver and set className and subid
    public linkTestCasesTogether(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        linkTestCasesTogether test = new linkTestCasesTogether(driver);
        test.runTest();
    }
}
