...
public class findSpecificTestRuns {

    private WebDriver driver;
    private String className = "findSpecificTestRuns";
    private String subid = "TE-157";

    // Constructor to initialize WebDriver and set className and subid
    public findSpecificTestRuns(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        findSpecificTestRuns test = new findSpecificTestRuns(driver);
        test.runTest();
    }
}
