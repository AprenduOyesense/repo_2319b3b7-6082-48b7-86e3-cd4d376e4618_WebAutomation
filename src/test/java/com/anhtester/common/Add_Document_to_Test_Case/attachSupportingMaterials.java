...
public class attachSupportingMaterials {

    private WebDriver driver;
    private String className = "attachSupportingMaterials";
    private String subid = "TE-100";

    // Constructor to initialize WebDriver and set className and subid
    public attachSupportingMaterials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        attachSupportingMaterials test = new attachSupportingMaterials(driver);
        test.runTest();
    }
}
