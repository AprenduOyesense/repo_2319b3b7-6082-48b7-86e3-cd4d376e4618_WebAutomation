...
public class evaluateRecentResults {

    private WebDriver driver;
    private String className = "evaluateRecentResults";
    private String subid = "TE-108";

    // Constructor to initialize WebDriver and set className and subid
    public evaluateRecentResults(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        evaluateRecentResults test = new evaluateRecentResults(driver);
        test.runTest();
    }
}
