...
public class changeTestCaseStatus {

    private WebDriver driver;
    private String className = "changeTestCaseStatus";
    private String subid = "TE-121";

    // Constructor to initialize WebDriver and set className and subid
    public changeTestCaseStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        changeTestCaseStatus test = new changeTestCaseStatus(driver);
        test.runTest();
    }
}
