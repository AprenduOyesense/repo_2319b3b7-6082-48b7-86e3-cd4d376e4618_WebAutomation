...
public class viewProgressForATestCaseInAProject {

    private WebDriver driver;
    private String className = "viewProgressForATestCaseInAProject";
    private String subid = "TE-169";

    // Constructor to initialize WebDriver and set className and subid
    public viewProgressForATestCaseInAProject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewProgressForATestCaseInAProject test = new viewProgressForATestCaseInAProject(driver);
        test.runTest();
    }
}
