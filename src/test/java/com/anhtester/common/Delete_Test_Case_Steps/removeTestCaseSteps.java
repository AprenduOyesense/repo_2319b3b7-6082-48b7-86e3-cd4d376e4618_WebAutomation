...
public class removeTestCaseSteps {

    private WebDriver driver;
    private String className = "removeTestCaseSteps";
    private String subid = "TE-142";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseSteps(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseSteps test = new removeTestCaseSteps(driver);
        test.runTest();
    }
}
