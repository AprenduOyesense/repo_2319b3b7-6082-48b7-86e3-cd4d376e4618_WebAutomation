...
public class accessSupportingMaterials {

    private WebDriver driver;
    private String className = "accessSupportingMaterials";
    private String subid = "TE-101";

    // Constructor to initialize WebDriver and set className and subid
    public accessSupportingMaterials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        accessSupportingMaterials test = new accessSupportingMaterials(driver);
        test.runTest();
    }
}
