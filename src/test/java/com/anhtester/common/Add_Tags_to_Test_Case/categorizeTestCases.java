...
public class categorizeTestCases {

    private WebDriver driver;
    private String className = "categorizeTestCases";
    private String subid = "TE-140";

    // Constructor to initialize WebDriver and set className and subid
    public categorizeTestCases(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        categorizeTestCases test = new categorizeTestCases(driver);
        test.runTest();
    }
}
