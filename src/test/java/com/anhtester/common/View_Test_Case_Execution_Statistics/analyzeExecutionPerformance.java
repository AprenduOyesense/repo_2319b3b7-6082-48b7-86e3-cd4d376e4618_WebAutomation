...
public class analyzeExecutionPerformance {

    private WebDriver driver;
    private String className = "analyzeExecutionPerformance";
    private String subid = "TE-102";

    // Constructor to initialize WebDriver and set className and subid
    public analyzeExecutionPerformance(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        analyzeExecutionPerformance test = new analyzeExecutionPerformance(driver);
        test.runTest();
    }
}
