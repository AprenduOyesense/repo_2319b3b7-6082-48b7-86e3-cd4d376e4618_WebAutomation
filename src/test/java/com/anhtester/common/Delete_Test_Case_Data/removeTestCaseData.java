...
public class removeTestCaseData {

    private WebDriver driver;
    private String className = "removeTestCaseData";
    private String subid = "TE-146";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseData test = new removeTestCaseData(driver);
        test.runTest();
    }
}
