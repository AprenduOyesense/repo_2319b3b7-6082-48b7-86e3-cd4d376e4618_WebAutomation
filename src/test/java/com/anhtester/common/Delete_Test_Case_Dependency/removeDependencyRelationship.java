...
public class removeDependencyRelationship {
    ...
    private String className = "removeDependencyRelationship";
    private String subid = "TE-149";

    // Constructor to initialize WebDriver and set className and subid
    public removeDependencyRelationship(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeDependencyRelationship test = new removeDependencyRelationship(driver);
        test.runTest();
    }
}
