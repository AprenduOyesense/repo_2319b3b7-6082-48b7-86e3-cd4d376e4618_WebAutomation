...
public class modifyExpectedOutcomes {

    private WebDriver driver;
    private String className = "modifyExpectedOutcomes";
    private String subid = "TE-118";

    // Constructor to initialize WebDriver and set className and subid
    public modifyExpectedOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        modifyExpectedOutcomes test = new modifyExpectedOutcomes(driver);
        test.runTest();
    }
}
