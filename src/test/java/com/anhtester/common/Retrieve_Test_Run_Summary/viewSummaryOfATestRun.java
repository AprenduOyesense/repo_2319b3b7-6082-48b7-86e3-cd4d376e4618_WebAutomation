...
public class viewSummaryOfATestRun {

    private WebDriver driver;
    private String className = "viewSummaryOfATestRun";
    private String subid = "TE-159";

    // Constructor to initialize WebDriver and set className and subid
    public viewSummaryOfATestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewSummaryOfATestRun test = new viewSummaryOfATestRun(driver);
        test.runTest();
    }
}
