...
public class removeTestCaseIdentity {

    private WebDriver driver;
    private String className = "removeTestCaseIdentity";
    private String subid = "TE-128";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseIdentity(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseIdentity test = new removeTestCaseIdentity(driver);
        test.runTest();
    }
}
