...
public class viewTestCaseExecutionDetails {

    private WebDriver driver;
    private String className = "viewTestCaseExecutionDetails";
    private String subid = "TE-152";

    // Constructor to initialize WebDriver and set className and subid
    public viewTestCaseExecutionDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewTestCaseExecutionDetails test = new viewTestCaseExecutionDetails(driver);
        test.runTest();
    }
}
