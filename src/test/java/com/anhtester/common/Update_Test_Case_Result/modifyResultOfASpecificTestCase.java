...
public class modifyResultOfASpecificTestCase {

    private WebDriver driver;
    private String className = "modifyResultOfASpecificTestCase";
    private String subid = "TE-162";

    // Constructor to initialize WebDriver and set className and subid
    public modifyResultOfASpecificTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        modifyResultOfASpecificTestCase test = new modifyResultOfASpecificTestCase(driver);
        test.runTest();
    }
}
