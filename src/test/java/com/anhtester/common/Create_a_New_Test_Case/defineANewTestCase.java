...
public class defineANewTestCase {

    private WebDriver driver;
    private String className = "defineANewTestCase";
    private String subid = "TE-127";

    // Constructor to initialize WebDriver and set className and subid
    public defineANewTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        defineANewTestCase test = new defineANewTestCase(driver);
        test.runTest();
    }
}
