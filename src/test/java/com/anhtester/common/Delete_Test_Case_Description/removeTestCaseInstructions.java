...
public class removeTestCaseInstructions {

    private WebDriver driver;
    private String className = "removeTestCaseInstructions";
    private String subid = "TE-131";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseInstructions(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseInstructions test = new removeTestCaseInstructions(driver);
        test.runTest();
    }
}
