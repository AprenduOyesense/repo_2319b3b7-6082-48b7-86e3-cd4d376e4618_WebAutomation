...
public class modifyTestCaseData {

    private WebDriver driver;
    private String className = "modifyTestCaseData";
    private String subid = "TE-147";

    // Constructor to initialize WebDriver and set className and subid
    public modifyTestCaseData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        modifyTestCaseData test = new modifyTestCaseData(driver);
        test.runTest();
    }
}
