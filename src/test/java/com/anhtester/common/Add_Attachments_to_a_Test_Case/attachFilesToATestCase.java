...
public class attachFilesToATestCase {

    private WebDriver driver;
    private String className = "attachFilesToATestCase";
    private String subid = "TE-155";

    // Constructor to initialize WebDriver and set className and subid
    public attachFilesToATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        attachFilesToATestCase test = new attachFilesToATestCase(driver);
        test.runTest();
    }
}
