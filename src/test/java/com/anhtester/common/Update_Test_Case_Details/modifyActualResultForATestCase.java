...
public class modifyActualResultForATestCase {

    private WebDriver driver;
    private String className = "modifyActualResultForATestCase";
    private String subid = "TE-170";

    // Constructor to initialize WebDriver and set className and subid
    public modifyActualResultForATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        modifyActualResultForATestCase test = new modifyActualResultForATestCase(driver);
        test.runTest();
    }
}
