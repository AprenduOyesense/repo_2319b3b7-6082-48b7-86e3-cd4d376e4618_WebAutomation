...
public class trackRecentActivity {

    private WebDriver driver;
    private String className = "trackRecentActivity";
    private String subid = "TE-109";

    // Constructor to initialize WebDriver and set className and subid
    public trackRecentActivity(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        trackRecentActivity test = new trackRecentActivity(driver);
        test.runTest();
    }
}