...
public class measureExecutionSpeed {

    private WebDriver driver;
    private String className = "measureExecutionSpeed";
    private String subid = "TE-110";

    // Constructor to initialize WebDriver and set className and subid
    public measureExecutionSpeed(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        measureExecutionSpeed test = new measureExecutionSpeed(driver);
        test.runTest();
    }
}
