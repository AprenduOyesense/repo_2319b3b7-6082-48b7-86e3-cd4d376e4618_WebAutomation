...
public class examineActualOutcomes {

    private WebDriver driver;
    private String className = "examineActualOutcomes";
    private String subid = "TE-116";

    // Constructor to initialize WebDriver and set className and subid
    public examineActualOutcomes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        examineActualOutcomes test = new examineActualOutcomes(driver);
        test.runTest();
    }
}
